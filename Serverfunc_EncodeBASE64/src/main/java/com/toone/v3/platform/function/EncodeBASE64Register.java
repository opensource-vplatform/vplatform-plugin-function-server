...
public class EncodeBASE64Register implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "EncodeBASE64";
    private static final String Plugin_Name = "对字符串编码";
    private static final String Plugin_Desc = "对字符串基于64位编码，返回值为字符串。";
