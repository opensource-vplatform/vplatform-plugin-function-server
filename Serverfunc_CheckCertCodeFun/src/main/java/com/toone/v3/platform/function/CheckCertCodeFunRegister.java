...
public class CheckCertCodeFunRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "CheckCertCodeFun";
    private static final String Plugin_Name = "校验验证码";
    private static final String Plugin_Desc = "校验输入的验证码是否正确。";
