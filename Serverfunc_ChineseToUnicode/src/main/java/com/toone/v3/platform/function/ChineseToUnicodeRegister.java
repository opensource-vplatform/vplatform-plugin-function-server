...
public class ChineseToUnicodeRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.ChineseToUnicode.Function_Code())
                .setDesc(ServerFuncCommonUtils.ChineseToUnicode.Function_Desc())
                .setName(ServerFuncCommonUtils.ChineseToUnicode.Function_Name())
