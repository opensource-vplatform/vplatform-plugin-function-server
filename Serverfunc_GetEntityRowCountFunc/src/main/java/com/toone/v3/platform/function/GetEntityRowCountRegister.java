...
public class GetEntityRowCountRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "GetEntityRowCountFunc";
    private static final String Plugin_Name = "根据条件从实体获取记录数";
    private static final String Plugin_Desc = "根据条件从实体获取记录数。";
