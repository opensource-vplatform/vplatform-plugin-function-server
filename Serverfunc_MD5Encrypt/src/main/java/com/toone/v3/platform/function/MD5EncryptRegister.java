...
public class MD5EncryptRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.MD5Encrypt.Function_Code())
                .setDesc(ServerFuncCommonUtils.MD5Encrypt.Function_Desc())
                .setName(ServerFuncCommonUtils.MD5Encrypt.Function_Name())
