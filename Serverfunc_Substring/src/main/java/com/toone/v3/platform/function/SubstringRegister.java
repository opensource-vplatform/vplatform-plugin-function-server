...
public class SubstringRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.Substring.Function_Code())
                .setDesc(ServerFuncCommonUtils.Substring.Function_Desc())
                .setName(ServerFuncCommonUtils.Substring.Function_Name())
