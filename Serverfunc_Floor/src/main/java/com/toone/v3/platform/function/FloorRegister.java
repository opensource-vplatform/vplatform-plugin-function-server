...
public class FloorRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "Floor";
    private static final String Plugin_Name = "小数的最大整数值";
    private static final String Plugin_Desc = "小数的最大整数值(返回小于或等于指定小数的最大整数值)。";
