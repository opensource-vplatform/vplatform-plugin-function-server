...
public class LastIndexOfRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.LastIndexOf.Function_Code())
                .setDesc(ServerFuncCommonUtils.LastIndexOf.Function_Desc())
                .setName(ServerFuncCommonUtils.LastIndexOf.Function_Name())
