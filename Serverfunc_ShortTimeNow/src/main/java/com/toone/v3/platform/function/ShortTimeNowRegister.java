...
public class ShortTimeNowRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.ShortTimeNow.Function_Code())
                .setDesc(ServerFuncCommonUtils.ShortTimeNow.Function_Desc())
                .setName(ServerFuncCommonUtils.ShortTimeNow.Function_Name())
