...
public class MinColumnRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.MinColumn.Function_Code())
                .setDesc(ServerFuncCommonUtils.MinColumn.Function_Desc())
                .setName(ServerFuncCommonUtils.MinColumn.Function_Name())
