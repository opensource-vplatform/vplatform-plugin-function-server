...
public class RemoveRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.Remove.Function_Code())
                .setDesc(ServerFuncCommonUtils.Remove.Function_Desc())
                .setName(ServerFuncCommonUtils.Remove.Function_Name())
