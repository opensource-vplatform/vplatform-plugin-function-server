...
public class InsertRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.Insert.Function_Code())
                .setDesc(ServerFuncCommonUtils.Insert.Function_Desc())
                .setName(ServerFuncCommonUtils.Insert.Function_Name())
