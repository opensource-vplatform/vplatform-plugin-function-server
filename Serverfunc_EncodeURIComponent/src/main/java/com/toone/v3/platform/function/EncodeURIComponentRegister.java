...
public class EncodeURIComponentRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "EncodeURIComponent";
    private static final String Plugin_Name = "对字符串作为URI组件进行编码";
    private static final String Plugin_Desc = "将字符串作为URI组件进行编码。";
