 ...
 * @Date 2021/6/1 16:05
 */
public class MinFunc implements IFunction {

    // 函数编码
    private final String funcCode = ServerFuncCommonUtils.Min.Function_Code();
    private final static Logger log = LoggerFactory.getLogger(MinFunc.class);
