...
public class RecyclingSequenceNumberRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "RecyclingSequenceNumber";
    private static final String Plugin_Name = "作废流水号";
    private static final String Plugin_Desc = "作废流水号";
