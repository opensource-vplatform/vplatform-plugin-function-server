...
public class PadLeftRegister implements IRegisterPlugin {
    ...
    private IFunctionProfileVo getFunc() {
        ...
        pluginBuilder.setAuthor(ServerFuncCommonUtils.Plugin_Author)
                .setCode(ServerFuncCommonUtils.PadLeft.Function_Code())
                .setDesc(ServerFuncCommonUtils.PadLeft.Function_Desc())
                .setName(ServerFuncCommonUtils.PadLeft.Function_Name())
