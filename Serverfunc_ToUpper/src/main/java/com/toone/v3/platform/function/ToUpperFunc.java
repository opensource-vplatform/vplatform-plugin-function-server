...
public class ToUpperFunc implements IFunction {
    ...
    // 函数编码
    private final String funcCode = ServerFuncCommonUtils.ToUpper.Function_Code();
    private final static Logger log = LoggerFactory.getLogger(ToUpperFunc.class);
