...
public class VRestoreXMLToEntityRegister implements IRegisterPlugin {
    ...
    public static final String Plugin_Code = "VRestoreXMLToEntityFunc";
    private static final String Plugin_Name = "将XML数据还原为实体数据";
    private static final String Plugin_Desc = "将XML数据还原为实体数据。";
